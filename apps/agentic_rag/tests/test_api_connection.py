...
def _check_endpoint(method: str, endpoint: str, data: Dict[str, Any] = None, files: Dict = None) -> Dict[str, Any]:
...
def main():
    ...
    # Test 1: Health Check
    print("\n[Test 1] Health Check")
    result = _check_endpoint("GET", "/a2a/health")
    results.append(("Health Check", result))
    
    # Test 2: Agent Card
    print("\n[Test 2] Agent Card")
    result = _check_endpoint("GET", "/agent_card")
    ...
    result = _check_endpoint("POST", "/a2a", a2a_health)
    ...
    result = _check_endpoint("POST", "/a2a", a2a_query)
    ...
    result = _check_endpoint("POST", "/query", query_data)
    results.append(("Standard Query", result))
    
    # Test 6: API Documentation
    print("\n[Test 6] API Documentation")
    result = _check_endpoint("GET", "/docs")
    results.append(("API Docs", result))
    
    # Test 7: OpenAPI Schema
    print("\n[Test 7] OpenAPI Schema")
    result = _check_endpoint("GET", "/openapi.json")
